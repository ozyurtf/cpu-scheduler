...
string inputFilePath = "/Users/ozyurtf/Documents/ms-cs/spring-2024/operating-systems/labs/lab2/lab2_assign/input8";

// ATTENTION: MAX PRIO IS 4 BY DEFAULT. CHECK THE OTHER DEFAULTS PARAMETERS.
string schedulerType = "SRTF";
...
struct Scheduler {
    ...
    PCB* getNextProcess() {
        ...
        // ATTENTION: FIND A FASTER AND MORE EFFICIENT WAY 
        // FOR BOTH THIS AND OTHER PLACES WHERE CONTAINERS ARE USED.
        if (!runQ.empty()) {
...
int main() {
    ...
    if (schedulerType == "PREPRIO" || schedulerType == "PRIO"){ 
        cout << schedulerType
             << " "
             << timeQuantum
             << endl;
